...
Route::middleware([SessionGuard::class])->prefix('/user/act')->group(function () {
      ...
      Route::post("/lls/d-e-e",[App\Http\Controllers\systems\lls_whip\lls\both\EstablishmentsController::class, 'delete_establishment_employee']);
      ...
      //Employees Record
         ...
         Route::post("/update-employee",[ App\Http\Controllers\systems\lls_whip\both\EmployeeController::class, 'update_employee']);
      //Contractors
      ...
      //Whip Code
         Route::get("/whip/g-w-c",[ App\Http\Controllers\systems\lls_whip\whip\user\MonitoringController::class, 'get_whip_code']);
