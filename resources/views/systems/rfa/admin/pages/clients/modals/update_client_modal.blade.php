<div class="modal fade" id="update_client_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
            ...
            <form id="update_client_form" class="p-2">
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            <div class="input-group ">
                                ...
                                <input type="number" class="form-control input" name="update_purok"
                        ...
                        <div class="form-group col-md-9">
                            <div class="input-group " style="height: 45px;">
                                ...
                                <select class="custom-select" id="input_barangay" name="update_barangay"
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="update_employment_status"
                            style="border: 1px solid;height: 45px;" required>
