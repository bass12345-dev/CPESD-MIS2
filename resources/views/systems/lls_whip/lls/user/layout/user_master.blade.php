...
<body>
	@include('systems.lls_whip.lls.includes.header_top_area')
	@include('systems.lls_whip.lls.user.layout.includes.main_menu')
	@include('systems.lls_whip.lls.user.layout.includes.mobile_menu')
	<main class="content">
		@yield('content')
	</main>
</body>
