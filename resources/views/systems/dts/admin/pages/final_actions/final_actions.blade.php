...
<div class="row">
    <div class="col-12  col-md-7 ">
        @include('systems.dts.admin.pages.final_actions.sections.table')
    </div>
    <div class="col-12 col-md-5">
        @include('systems.dts.admin.pages.final_actions.sections.form')
    </div>
</div>
...
document.addEventListener("DOMContentLoaded", function () {
        table = $("#datatables-buttons").DataTable({
            ...
            ajax: {
                url: base_url + "/admin/act/dts/final-actions",
                method: 'GET',
                headers: {
