<div class="modal fade" id="add_officers_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
   aria-hidden="true">
      ...
      <div class="modal-content">
         ...
         <form id="add_officer_form" class="p-2">
            <div class="modal-body">
               <input type="hidden" name="cso_id" value="{{$row->cso_id}}">
               ...
               <div class="form-group">
                  ...
                  <input type="text" value="09" class="form-control input" name="officer_contact_number" placeholder=""
